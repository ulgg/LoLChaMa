...
var riotApiUrlStaticChampionInfo_beforeChmpId = 'https://global.api.pvp.net/api/lol/static-data/jp/v1.2/champion/';
  ...
  async.waterfall([
    ...
    function tweetTopchampions(champMasteriyInfos, callback2) {
      var data = ' \n <3<3<3 ' + champMasteriyInfos[0].championName
                 + ' (' + champMasteriyInfos[0].championPoints + ' Ponints)'
               + ' \n <3<3     ' + champMasteriyInfos[1].championName
                  + ' (' + champMasteriyInfos[1].championPoints + ' Ponints)'
               + ' \n <3         ' + champMasteriyInfos[2].championName
                 + ' (' + champMasteriyInfos[2].championPoints + ' Ponints)'
               + ' \n #LoLChaMa';
